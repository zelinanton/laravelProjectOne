...
<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
      <div class="p-4 sm:p-8 dark:bg-gray-800 shadow sm:rounded-lg bg-blue-dark">
        <h2 class="font-semibold text-xl leading-tight text-center text-white">Добавить товар</h2>
        <form method="post" 
